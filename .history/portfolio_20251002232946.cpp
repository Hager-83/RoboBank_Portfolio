...
BaseAccount::BaseAccount(const string& id, const AccountSettings& settings, int64_t opening_balance)
...
int64_t  BaseAccount::balance_cents() const
{
...
void BaseAccount::post_simple_interest(int days, int basis, int64_t ts,string note)
{
...
/**********  CheckingAccount **********/
CheckingAccount::CheckingAccount (const string& id, const AccountSettings& settings, int64_t opening_balance)
...
void CheckingAccount::apply_monthly_fee(uint_64_t ts)
{
    charge_fee(settings_.fee_flat_cents, ts, " monthly fee.");
}

/**********  SavingsAccount **********/
SavingsAccount::SavingsAccount (const string& id, const AccountSettings& settings, int64_t opening_balance)
    :BaseAccount(id, settings, opening_balance){}
...
/**********  Portfolio **********/
bool Portfolio::add_account(const string& id, const AccountSettings& settings, int64_t opening_balance)
{
