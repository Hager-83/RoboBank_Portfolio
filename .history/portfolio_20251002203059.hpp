...
class  BaseAccount : public IAccount {
    ...
    public:
         ...
         *  @param note Transaction note (optional)
         */
        virtual void deposit(int64_t amount_cents, int64_t ts, string note = nullptr) override;
         ...
         *  @param note Transaction note (optional)
         */
        virtual void withdrawal(int64_t amount_cents, int64_t ts, string note = nullptr) override;
         ...
         *  @param note Transaction note (optional)
         */
        virtual void charge_fee(int64_t fee_cents, int64_t ts,
         ...
         *  @param note Transaction note (optional)
         */
        virtual void post_simple_interest(int days, int basis, int64_t ts,string note) override;
...
class CheckingAccount : public BaseAccount {
    publicCheckingAccount(const string& id, const AccountSettings& settings,
