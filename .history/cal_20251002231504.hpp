 ...
 * @param days              Number of days the interest is accrued for.
 * @param day_count_basis   The number of days in a year used for interest calculation (e.g., 365 or 360).
 * @param rounding_policy   Policy for rounding the result (e.g., 'E' = Half Even).
 * @return The calculated simple interest amount, rounded as specified.
