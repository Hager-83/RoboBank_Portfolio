 ...
 * @param rounding_policy   Rounding policy to the result 
...
/**
 * @brief Calculates a percentage of a given amount
 *
 * @param amount            The base amount to calculate from
...
/**
 * @brief Validates that a given interest or percentage rate is acceptable
 *
...
/**
 * @brief Validates that a given amount is non-negative
 *
 * @param amount The amount to validate.
 * @return true if the amount is zero or positive, false otherwise.
 */
