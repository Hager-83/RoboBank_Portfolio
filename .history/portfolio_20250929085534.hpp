#ifndef _POTRFOLIO_HPP
#define _POTRFOLIO_HPP
...
class Portfolio 
{
    ...
    public:
        ...
        void applay_all(const vector::<TxRecord>& txs);
        void applay_from_ledger(const string* tx_account_id,const int* tx_type,const long long* tx_amount_cents, int tx_count);
        bool transfer(const TransferRecord& tr);
        long long total_exposure() const;
};


#endif /*_POTRFOLIO_HPP */